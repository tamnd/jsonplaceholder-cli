...
Most of these come down to network reality or how jsonplaceholder serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

jsonplaceholder rate-limits like any public site. jsonplaceholder already paces
...
Where a surface is gated, jsonplaceholder reads a cookie or token you supply
...
`jsonplaceholder`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what jsonplaceholder actually did
