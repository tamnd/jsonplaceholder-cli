...
```
jsonplaceholder <command> [arguments] [flags]
```

Run `jsonplaceholder <command> --help` for the full flag list on any command. This
...
per operation you declare in `jsonplaceholder/domain.go`.
