...
// HTTP behaviour is covered in jsonplaceholder_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "jsonplaceholder://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("jsonplaceholder", "about")
	if err != nil || got.String() != "jsonplaceholder://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want jsonplaceholder://page/about", got.String(), err)
	}
}
